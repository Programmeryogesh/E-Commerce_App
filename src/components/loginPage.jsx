...
export default function LoginPage() {
    ...
    const handleSubmit = (event) => {
        ...
        if (userData.password.length > 4 && emailRegex.test(userData.email)) {
                ...
                <Grid item xs={12} sm={8} md={5} component={Paper} elevation={6} square>
                    ...
                    >
                        ...
                        <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 1 }}>
                            ...
                            <Grid container>
                                <Grid item xs>
                                    <Link  style={{cursor:"pointer" , color:"#0053ff"}} to="#" variant="body2">
                                        Forgot password?
                                    </Link>
                                </Grid>
                                <Grid item>
                                    <Link style={{cursor:"pointer" , color:"#0053ff"}} to={'/login/SignUp'} variant="body2">
